...
<div class="container d-flex flex-column align-items-end py-5" style="gap: 64px;">
    ...
    <p class="w-100" style="font-size: 20px;">A quelle heure vous levez-vous generalement en semaine ?</p>
    ...
    <a href="/question8" class="px-4 py-2 text-white rounded-pill border border-0 text-decoration-none green">Page Suivante</a>
</div>
