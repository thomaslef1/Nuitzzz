...
<div class="container d-flex flex-column align-items-end py-5" style="gap: 64px;">
    <h1 class="w-100" style="font-weight: bold;">Autres facteurs:</h1>
    <p class="w-100" style="font-size: 20px;">Avez vous des conditions medicales qui pourraient affecter votre sommeil ?</p>
    ...
    <a href="/question15" class="px-4 py-2 text-white rounded-pill border border-0 text-decoration-none green">Page Suivante</a>
</div>
